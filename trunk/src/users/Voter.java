...
/**
 * This Class is a super class to all classes that hold preferences, 
 * it holds the courses that are preferred.
 * 
...
public class Voter extends AuthenticatableUser {
	...
	/**
	 * This method adds a course to the Set of preferred courses 
	 * is it is not already in the Set.
	 * 
