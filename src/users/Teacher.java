...
/**
 * This class represent the data for a teacher's preferences and profile It holds
 * the teachers time's they are available to teach the maximum credit load they
 * are willing to take on, the classes they are willing and unwilling to teach 
 * 
...
public class Teacher extends Voter {
	/**
	 * This is the constant for the default number of credits a teacher can
	 * teach.
	 */
