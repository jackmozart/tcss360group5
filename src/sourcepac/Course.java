package sourcepac;
/**
 * This class holds the basic information about a course including the Course title
 * course description, and the course's credit worth.
 * 
...
public class Course {
	/**
	 * This field holds the the course title which consists of the Department and level number
	 * and should be formatted like this: TCSS 360
	 */
	private String my_course_title;
	/**
	 * This field holds the course description; the full name of the course, such as:
	...
	/**
	 * This method returns a string representation of the course including the course
	 * title course description and course credit.
	 * 
